 ...
 * alternate, D-98. The newsletter's signup and web archive (D-103) are Norwegian only, each
 * issue with the date it went out.
 */
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  return [
    ...
    { url: `${MAIN_URL}/nyhetsbrev`, changeFrequency: 'yearly', priority: 0.4 },
    { url: `${MAIN_URL}/nyhetsbrev/arkiv`, lastModified: issues[0]?.published_at, changeFrequency: 'weekly', priority: 0.5 },
