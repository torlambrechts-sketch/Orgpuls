...
/**
 * What design 3's Resultater reads (0037's `results_workspace`), as it arrives inside
 * `results_digest` (0044, lib/results/digest.ts).
 *
...
export const orNull = <T extends z.ZodTypeAny>(schema: T) =>
