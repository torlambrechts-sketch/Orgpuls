 ...
 */
export const SECTIONS = ['dashboard', 'orgs', 'health', 'users', 'ops', 'web', 'seo', 'crm', 'tickets', 'audit', 'admins'] as const
...
const BY_ROLE: Record<AdminRole, readonly Section[]> = {
  ...
  finance: ['dashboard', 'orgs', 'health', 'web'],
  analyst: ['dashboard', 'web', 'seo', 'crm'],
  ...
  marketing: ['dashboard', 'health', 'web', 'seo', 'crm'],
}
