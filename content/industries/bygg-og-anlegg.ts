...
export const byggOgAnlegg: IndustryPage = {
  ...
  law: {
    ...
    items: [
      ...
      { ref: 'aml § 2-2', text: 'Når flere arbeidsgivere er på samme arbeidsplass, skal hovedbedriften samordne HMS-arbeidet.', reviewed: false },
      { ref: 'aml § 2-3', text: 'Arbeidstaker skal avbryte arbeidet ved fare for liv eller helse, og melde fra om feil og mangler.', reviewed: false },
      { ref: 'aml § 3-2', text: 'Arbeidsgiver skal sørge for nødvendig opplæring, øvelse og instruksjon.', reviewed: false },
      {
        ref: 'Språkkravet',
